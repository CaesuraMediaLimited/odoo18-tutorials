...
## ./models/account_move.py           - 1. Contact Status
                                        5. Override the invoice to depend on Salespeople only
...
## ./models/res_partner.py            - 1. contact_status
                                        4. Other Addresses
                                        6. credit_limit
...
## ./views/res_partner_views.xml          - 8. Move Payment Terms to Accounting tab
                                            4. Other Addresses,
