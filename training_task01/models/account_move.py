"""Module inheriting account.move."""
...
class AccountMove(models.Model):
    ...
    # Override the invoice_user_id (Salesperson) and make it depend on
    # this custom module's is_sales_person.
    # ~/Odoo18/odoo/addons/account/models/account_move.py
    #
    invoice_user_id = fields.Many2one(
        "res.users", string="Salesperson", domain="[('is_sales_person', '=', True)]"
    )
