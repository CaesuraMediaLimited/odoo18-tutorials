...
class ResPartner(models.Model):
    ...
    customer_grades_id = fields.Many2many(
        "res.partner.grades", string="Customer Grades"
    )
    ...
    def _onchangeccai(self):
        for partner in self:
            ...
            # Obvs.
            selected_contact = self.env["res.partner"].browse(
                partner.company_contact_address_id.id
            )
